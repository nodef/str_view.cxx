...
Author: [Adam Sawicki](https://github.com/sawickiap) - https://asawicki.info<br>
...
And then include `str_view.hpp` as follows:
```c
#include "node_modules/str_view.cxx/str_view.hpp"
```
...
![](https://ga-beacon.deno.dev/G-RC63DPBH3P:SH3Eq-NoQ9mwgYeHWxu7cw/github.com/nodef/str_view.cxx)
[![SRC](https://img.shields.io/badge/src-repo-green?logo=Org)](https://github.com/sawickiap/str_view)
